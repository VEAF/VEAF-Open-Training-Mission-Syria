...
if veafNamedPoints then
	...
	veafNamedPoints.Points = {
        -- Turkish Airports
        {name="INCIRLIK AB",point=coord.LLtoLO("37.001944","35.425833")},
        {name="ADANA SAKIRPASA INTL",point=coord.LLtoLO("36.981944","35.280278")},
        {name="HATAY AIRPORT",point=coord.LLtoLO("36.360278","36.285000")},

        -- Syrian Airports
        {name="MINAKH HELIPT",point=coord.LLtoLO("36.521944","37.041111")},
        {name="ALEPPO INTL",point=coord.LLtoLO("36.180556","37.224167")},
        {name="KUWEIRES AB",point=coord.LLtoLO("36.186944","37.583056")},
        {name="JIRAH AB",point=coord.LLtoLO("36.097500","37.940278")},
        {name="TAFTANAZ HELIPT",point=coord.LLtoLO("35.972222","36.783056")},
        {name="ABU AL DUHUR AB",point=coord.LLtoLO("35.732778","37.101667")},
        {name="TABQA AB",point=coord.LLtoLO("35.754444","38.566667")},
        {name="BASSEL AL ASSAD (KHMEIMIM)",point=coord.LLtoLO("35.400833","35.948611")},
        {name="HAMA AB",point=coord.LLtoLO("35.118056","36.711111")},
        {name="AL QUSAYR AB",point=coord.LLtoLO("34.570833","36.571944")},
        {name="PALYMYRA AIRPORT",point=coord.LLtoLO("34.557222","38.316667")},
        {name="AN NASIRIYAH AB",point=coord.LLtoLO("33.918889","36.866389")},
        {name="AL DUMAYR AB",point=coord.LLtoLO("33.609444","36.748889")},
        {name="MEZZEH AB",point=coord.LLtoLO("33.477500","36.223333")},
        {name="MARJ AS SULTAN NTH HELIPT",point=coord.LLtoLO("33.500278","36.466944")},
        {name="MARJ AS SULTAN STH HELIPT",point=coord.LLtoLO("33.486944","36.475278")},
        {name="QABR AS SITT HELIPT",point=coord.LLtoLO("33.458611","36.357500")},
        {name="DAMASCUS INTL",point=coord.LLtoLO("33.415000","36.519444")},
        {name="MARJ RUHAYYIL AB",point=coord.LLtoLO("33.286389","36.457222")},
        {name="KHALKHALAH AB",point=coord.LLtoLO("33.077222","36.558056")},

        -- Lebanese Airports
        {name="RENE MOUAWAD AB",point=coord.LLtoLO("34.589444","36.011389")},
        {name="HAJAR AB",point=coord.LLtoLO("34.283333","35.680278")},
        {name="BEIRUT INTL",point=coord.LLtoLO("33.821111","35.488333")},
        {name="RAYAK AB",point=coord.LLtoLO("33.852222","35.990278")},

        -- Israeli Airports
        {name="KIRYAT SHMONA AIRPORT",point=coord.LLtoLO("33.216667","35.596667")},
        {name="HAIFA INTL",point=coord.LLtoLO("32.809167","35.043056")},
        {name="RAMAT DAVID INTL",point=coord.LLtoLO("32.665000","35.179444")},
        {name="MEGIDDO AIRFIELD",point=coord.LLtoLO("32.597222","35.228611")},
        {name="EYN SHEMER AIRFIELD",point=coord.LLtoLO("32.440556","35.007500")},

        -- Jordan Airports
        {name="MAFRAQ AB",point=coord.LLtoLO("32.356389","36.259167")},
